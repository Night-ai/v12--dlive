...
exports.run = async(client, message, args) => {
  let prefix = (await db.fetch(`prefix_${message.guild.id}`)) || "!";  
    const embed = new Discord.MessageEmbed()
	   ...
	   .setDescription(`
   **» ${prefix}reklamlog ** <a:sagok:778555821285441546> Reklam engel logunu ayarlarsınız.
   **» ${prefix}küfürlog ** <a:sagok:778555821285441546> Küfür engel logunu ayarlarsınız.
   `)
